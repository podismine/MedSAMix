...
#             print('input_image:',input_image.shape,'max:',input_image.max(),'min:',input_image.min())
...
#         print('points:',points,'boxes:',boxes,'mask_input:',mask_input)
#         print('self.features:',self.features.shape, 'Min:',self.features.min(),'Max:',self.features.max(),'Mean:',self.features.mean(),'Std:',self.features.std(),
#               '\nsparse_embeddings:',sparse_embeddings.shape,'dense_embeddings:',dense_embeddings.shape)
#         print('multimask_output:',multimask_output,'attn_sim:',attn_sim,'target_embedding:',target_embedding)
